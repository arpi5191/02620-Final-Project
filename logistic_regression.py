...
print('Logistic Regression model without PC transformation.')
...
print(find_matrix(testing_Y, turn_p_to_y(predicted_Y))[:4])

print('Logistic Regression model with PC transformation.')
num_PCs_needed, variance_covered, principle_components = find_PCs(training_X)
print('number of PCs needed: ' + str(num_PCs_needed))
print('amount of variance covered: ' + str(variance_covered))
...
print('true positive, true negative, false positive, false negative')
print(find_matrix(testing_Y, turn_p_to_y(predicted_Y_PCA))[:4])
